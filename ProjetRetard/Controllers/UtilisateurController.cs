...
namespace ProjetRetard.Controllers
{
    public class UtilisateurController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Nom,Prenom,Classe,AdresseMail,MotDePasse")] Utilisateur utilisateur)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nom,Prenom,Classe,AdresseMail,MotDePasse")] Utilisateur utilisateur)
        {
            if (ModelState.IsValid)
            {
